...
url_file_name = "Medium_scrape_urls_multi-tag _clean_2016-2020"
...
content_df = pd.DataFrame(columns = ['UUID', 'url','title', 'subtitle','tags', 'author', 'h1_headers', 'h2_headers', 'paragraphs', 
